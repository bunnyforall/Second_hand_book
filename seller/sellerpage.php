...
<body style="background-color:rgba(214, 211, 200, 0.962);">
<nav style="padding-right: 30px;padding-left: 80px; background-color:black;">
		<div>
			...
			<ul id="nav-mobile" class="right hide-on-small-and-down">
                ...
                <li><a href="view_all_sales.php" class="btn brand z-depth-0">View all donations</a></li>
			</ul>
		</div>
        <br>
...
<div class="container">
        <h1 class="text center">Welcome <?php print_r($row2["seller_name"]);?></h1>
        <div class="container ">
        <h6 ><i> Personal Details</i></h6>
        <h7 > Donor email: <?php print_r($row2["seller_email"]);?></h7><br>
        <h7 > Donor phone: <?php print_r($row2["seller_phone"]);?></h7><br>
        <h7 > Donor Address: <?php print_r($row2["seller_address"]);?></h7><br>
        </div>
        <br>
        <div class="center">
                ...
                <div class="col s6 md3">
  				    <div class="card grey lighten-3">
                        ...
                        <div class="card-content">
                            ...
                            <h5>pagePoints: <?php echo htmlspecialchars($pr['product_price']);?></h5>
                                <h5>Status: <?php
                                                if($pr['status']){
