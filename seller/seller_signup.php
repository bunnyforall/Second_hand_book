...
<head>
    ...
    <title> Donor Onboarding</title>
</head>
<body>
<nav class="black z-depth-0">
		<div class ="container">
			<a href="seller_login.php" class="brand-logo brand-text">SecondPage</a>
...
<h1 class="center white-text"><?php echo $message;?></h1>
 <form class="white" method="POST" enctype="multipart/form-data">
     ...
     <label style="font-size:18px; color:black;">Donor_username</label>
     ...
     <label style="font-size:18px; color:black;">Re-enter Password</label>
