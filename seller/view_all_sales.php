...
<div class="container">
    <section>
    <div class="row">
    <h2 class="white-text" style="text-align:center;">Your Donations</h2>
    <h3 class="white-text" style="text-align:center;">Total pagePoints: <?php echo $totalsales;?></h3>
