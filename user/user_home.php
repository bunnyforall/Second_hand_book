...
<nav style="padding-right: 30px;padding-left: 80px; background-color: black;">
    ...
    <div class="container">
        <h1 class="text center">Welcome <?php print_r($urow["cust_name"]);?></h1>
        <div class="center">
            <h4 class="text center"> pagePoint Balance: <?php echo $urow['cust_balance'];?></h4>
