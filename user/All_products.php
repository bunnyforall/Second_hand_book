...
<nav style="padding-right: 30px;padding-left: 80px; background-color: black;">
		<div>
			<a href="user_home.php" class="brand-logo brand-text hide-on-med-and-down">SecondPage</a>
...
<div class="container">
    ...
    <h4 class="white-text center"> Remaining Points: <?php echo $urow['cust_balance'];?></h4>
            ...
            <div class="col s6 md3">
                      ...
                      <center>
                        <div class="card-content">
                          ...
                          <br>
                          <h5> pagePoints: <?php echo $p['product_price'];?></h5>
                          <h7> Donor ID: <?php echo $p['seller_id'];?></h7>
                          <br>                  
                          <a href="purchase.php?product_id=<?php echo $p['product_id']; ?>" class="btn brand z-depth-0">Request Now!</a>
                          </div>
                        </div>
                        </center>
                    </div>
