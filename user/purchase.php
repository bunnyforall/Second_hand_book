...
<h2 class="white-text" style="text-align:center;">Transaction Form</h2>
    ...
    <center>
        ...
        <h3>Product Points: <?php echo $prod['product_price'];?></h3>
        <img src="<?php echo $prod['product_img'];?>" height=300px>
        <h3>Donor ID: <?php echo $prod['seller_id'];?></h3>
    </center>
        <h4><strong>Description: </h4></strong><h5><?php echo $prod['product_desc'];?></h5>    
    <hr>
    <h3>Your pagePoint Balance: <?php echo $urow1['cust_balance']?></h3>
    ...
    <form action="" method="post">
        ...
        <label style="font-size:18px; color:white;">Do you want to make this transaction?</label>
        <div><br></div>
        <div class="center">
