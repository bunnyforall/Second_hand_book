...
<div class="container">
        <h1 class="text center"> Welcome <?php print_r($arow["admin_name"]);?></h1>
        <div class="container ">
        <h6><i> Personal Details</i></h6>
        <h7> Admin email: <?php print_r($arow["admin_email"]);?></h7><br>
        <h7> Admin phone: <?php print_r($arow["admin_phone"]);?></h7><br>
        <h7> Admin Address: <?php print_r($arow["admin_address"]);?></h7><br>
        </div>
</div>
<div class="blackbgbg">
    <div class="container">
    <section>
    <div class="row">
        <h1 class="white-text center">All Receipients</h1>
                ...
                <div class="col s12 md6">
  				    <div class="card grey lighten-3">
                        <div class="card-content">
                            ...
                            <h6>Address: <?php echo htmlspecialchars($c['cust_address']);?></h6>
